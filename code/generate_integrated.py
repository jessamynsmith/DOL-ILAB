...
def xml_integrated_goods_by_country(goods_list, filename):
...
def xml_integrated_goods_by_good(goods_list, filename):
...
if __name__ == '__main__':
	glist = generate_goods.get_goods_from_excel()
	plist = generate_products.get_products_from_excel()

	full_list = integrate(glist, plist)

	xml_integrated_goods_by_country(full_list, "../output/all_goods_by_country.xml")
	xml_integrated_goods_by_good(full_list,"../output/all_goods_by_good.xml")
